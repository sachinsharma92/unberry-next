...
export default function PrivacyPolicyScreen() {
  ...
  return (
    <>
      ...
      <div className={styles.privacySectionStyle}>
        <div className={styles.header}>
          <div className={styles.maxWrap}>
            <Link href="/">
              <a className={`${styles.logoWhite} logo-white`}>
                <ImageCustom src="logo-brown.svg" alt="logo" width="200" height="22" />
              </a>
            </Link>

            <h2 className={styles.title2}>Privacy Policy</h2>
            <p className={styles.description}>Last Updated April 2023</p>
          </div>
        </div>

        <div className={`${styles.content} ${styles.maxWrap}`}>
          <p className={styles.description}>For Unberry and its affiliates <span className={styles.bold}>(“Unberry”)</span>, protecting your personal information <span className='bold'>(“Personal Information” or “Personal Data” as defined below)</span> is our priority.</p>
          <p className={styles.description}>
            We have prepared this privacy policy <span className={styles.bold}>(“Privacy Policy”)</span> to describe to you (“you” or the “candidate”) our practices regarding the Personal Information we collect from you as candidate (of our website, located at Unberry.com, our mobile application <span className='bold'>(“Application(s)”)),</span> and our widgets (collectively, the <span className='bold'>“Site”)</span> and all online services of Unberry and its affiliates <span className='bold'>(“Services”)</span>.
          </p>
          <p className={styles.description}>
          ...
          <h4 className={styles.title4}>What is the purpose of collecting your Personal Information?</h4>
          <p className={styles.description}>
          ...
          <h4 className={styles.title4}>How will your data be used?</h4>
